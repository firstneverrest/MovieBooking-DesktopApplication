...
public class ticket2 extends javax.swing.JFrame {
    ...
    private void nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextActionPerformed
        ...
        try {
            ...
            output.println("Movie title : "+Starter.tick2.movietitle.getText());
            output.println("Theater : "+Starter.tick2.theater.getText());
            output.println("Show time : "+Starter.tick2.showTime.getText());
            output.print("Seat No. : "+Starter.tick2.seatNo.getText()+"    ");
            output.println("Seat Type : "+Starter.tick2.seatType.getText());
            output.println("Price : "+Starter.tick2.price.getText());
            output.println("************************");
            output.close();
        ...
        File file2 = new File("seat2.txt"); 
        try (FileWriter fileWrite = new FileWriter(file2,true); 
            PrintWriter output = new PrintWriter(fileWrite)) {
            output.print(Starter.tick2.showTime.getText()+" ");
            output.println(Starter.tick2.seatNo.getText());
            output.close();
        }   catch (FileNotFoundException e) {
                System.out.println("File doesn't exist");
        }   catch (IOException ex) { 
