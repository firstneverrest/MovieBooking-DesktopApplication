...
import static movietheater.mainMenu.firstTime2;

public class Theater2 extends javax.swing.JFrame {

    public ArrayList<JLabel> theater2Seat = new ArrayList<>();
    ...
    public double calculation(){
        int sum = 0;
        int cnt=0;
        JLabel label = theater2Seat.get(theater2Seat.size()-1);
            if(label.getName().substring(0,1).equals("A") || label.getName().substring(0,1).equals("B")){
                sum = 200;
            }
            else
                sum = 150;
        Starter.tick2.seatNo.setText(label.getName());
        Starter.tick2.price.setText(""+sum);
        Starter.tick2.showTime.setText(Starter.menu.jComboBox2.getSelectedItem().toString());
        if (sum == 150)
            Starter.tick2.seatType.setText("Normal");
        else if (sum == 200)  
            Starter.tick2.seatType.setText("Special");
        Starter.tick2.theater.setText("Theater2");
        Starter.tick2.movietitle.setText(Starter.menu.MTitle2.getText());          
        return sum;
    }
    public void Seat(){
    ...
    private void initComponents() {
        ...
        jLabel103.setBackground(new java.awt.Color(255, 153, 102));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        for(int i = 0;i<theater2Seat.size();i++){
            if(theater2Seat.get(i).getBackground().equals(test1.getBackground())){
                cnt++;
            }
        }
        if(theater2Seat.size()==0 || cnt == 0 ){
            JOptionPane.showMessageDialog(null, "Please select your seat.");
        }
        else{
            for(JLabel label : theater2Seat){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Theater2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
