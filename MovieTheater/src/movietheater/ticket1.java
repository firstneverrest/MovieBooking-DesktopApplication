...
public class ticket1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        next.setFont(new java.awt.Font("Angsana New", 0, 20)); // NOI18N
        next.setText("Next");
    ...
    File file = new File("MovieTheater.txt");
     ...
     try (FileWriter fileWrite = new FileWriter(file,true); // append mode
        PrintWriter output = new PrintWriter(fileWrite)) {          
        output.println("******** Ticket ********");
        output.println("Movie title : "+Starter.tick1.movietitle.getText());
        output.println("Theater : "+Starter.tick1.theater.getText());
        output.println("Show time : "+Starter.tick1.showTime.getText());
        output.print("Seat No. : "+Starter.tick1.seatNo.getText()+"    ");
        output.println("Seat Type : "+Starter.tick1.seatType.getText());
        output.println("Price : "+Starter.tick1.price.getText()); 
        output.println("************************");
        output.close();
    ...
    File file2 = new File("seat1.txt"); 
    try (FileWriter fileWrite = new FileWriter(file2,true); 
        PrintWriter output = new PrintWriter(fileWrite)) {  
        output.print(Starter.tick1.showTime.getText()+" ");
        output.println(Starter.tick1.seatNo.getText());
        output.close();
    } catch (FileNotFoundException e) {
        System.out.println("File doesn't exist");
    }  catch (IOException ex) { 
